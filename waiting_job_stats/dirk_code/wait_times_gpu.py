...
df_cpu_wait = pd.read_csv("waiting_time_gpu_2024-12-20_1month.txt", sep='\s+', names=['JobID', 'JobState', 'User', 'Partition', 'ElapsedTime', 'SubmitTime', 'StartTime'], date_format='Y-M-D')
