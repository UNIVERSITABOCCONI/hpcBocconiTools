...
def read_file_to_dataframe(file_path):
    ...
    # Assign column names
    df.columns = ['Date', 'GPU_usage', 'CPU_usage']
...
if __name__ == '__main__':
    ...
    new_input_file = input_file.replace("/root/utilities/hpcBocconiTools/clusterUsage/", "")
    output_file = "/root/utilities/hpcBocconiTools/dataToReport/clusterUsageData/"+new_input_file+".csv"
