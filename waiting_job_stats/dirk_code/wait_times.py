...
df_cpu_wait = pd.read_csv("data/waiting_time_cpu_2025-02-02_2025-03-02.txt", sep='\s+', names=['JobID', 'JobState', 'User', 'Partition', 'ElapsedTime', 'SubmitTime', 'StartTime'], date_format='Y-M-D')
